...
async function createTodo(data: FormData) {
  ...
  if (typeof title !== 'string' || title.length < 1) throw Error('Invalid title')
...
export default async function Page() {
  ...
  return (<>
    ...
    <form action={createTodo} className="flex gap-2 flex-col mt-2">
      <input placeholder="Todo...." type="text" name="title" className="border border-slate-300 bg-transparent rounded px-2 py-1 outline-none focus-within:border-slate-100" />
